...
class DirectoryComponent(tk.Frame):
    ...
    def __init__(self, master, filename, file_path, working_path):
...
def refresher(filename, file_path, clicked_folder_path):
    ...
    for filename in files:
        ...
        file_label1 = DirectoryComponent(window, filename, new_file_path, working_path)
...
for filename in files:
    ...
    file_label1 = DirectoryComponent(window, filename, file_path, working_path)
    file_label1.pack(fill=tk.X, pady=3)
